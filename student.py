...
class Student:
	...
	def __init__(self, root):
		...
		self.var_teacher=StringVar()
       	...
       	# # First Image
		# img=Image.open(imgPath+"/girl.jpeg")
		# img=img.resize((500,130),Image.ANTIALIAS)
		# self.photoimg=ImageTk.PhotoImage(img)

		# lab=Label(self.root,image=self.photoimg)
		# lab.place(x=0,y=0,width=500,height=130)

		# # Second Image
		# img1=Image.open(imgPath+"/smartAttendance.jpg")
		# img1=img1.resize((500,130),Image.ANTIALIAS)
		# self.photoimg1=ImageTk.PhotoImage(img1)

		# lab1=Label(self.root,image=self.photoimg1)
		# lab1.place(x=500,y=0,width=500,height=130)

		# # Third Image
		# img2=Image.open(imgPath+"/clg.jpg")
		# img2=img2.resize((500,130),Image.ANTIALIAS)
		# self.photoimg2=ImageTk.PhotoImage(img2)

		# lab2=Label(self.root,image=self.photoimg2)
		# lab2.place(x=1000,y=0,width=550,height=130)
		...
		#title
		title=Label(bg_lab,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="green")
		...
		lab2.place(x=5,y=0,width=720,height=130)
		...
		dep_combo["values"]=("Select Department","CSE","EE","EEE","ECE","ME","CV","BBA","MBA","MCA")
		dep_combo.current(0)
		...
		class_student_frame.place(x=5,y=260,width=720,height=340)
		...
		# Teacher name
		class_teacher_label=Label(class_student_frame,text="Teacher Name:",font=("times new roman",13,"bold"),bg="white")
		class_teacher_label.grid(row=4,column=2,padx=10,pady=5,sticky=W)

		class_teacher_entry=ttk.Entry(class_student_frame,textvariable=self.var_teacher,width=20,font=("times new roman",13,"bold"))
		...
		btn_frame1.place(x=0,y=242,width=715,height=30)
		...
		# right label frame
		right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Admin Details",font=("times new roman",12,"bold"))
		right_frame.place(x=750,y=10,width=720,height=580)

		# right label frame image
		img_right=Image.open(imgPath+"/student.jpg")
		img_right=img_right.resize((720,130),Image.ANTIALIAS)
		self.photoimg_right=ImageTk.PhotoImage(img_right)

		lab2=Label(right_frame,image=self.photoimg_right)
		lab2.place(x=5,y=0,width=720,height=130)
	...
	def add_data(self):
		if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id=="":
			...
			try:
				...
				self.fetch_data()
				conn.close()
				messagebox.showinfo("Success","Student data has successfully added",parent=self.root)
...
# ========================== update function ====================================
	def update_data(self):
		if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id=="":
			...
			try:
				Update=messagebox.askyesno("Update","Do you want to update student deatils",parent=self.root)
				if Update>0:
					conn=mysql.connector.connect(host="localhost",username="root",password="Sambit",database="face_recognition")
					my_cursor=conn.cursor()
					...
					if not Update:
						return
				messagebox.showinfo("Sucessful","Student details sucessfully updated",parent=self.root)
				conn.commit()
				self.fetch_data()
				conn.close()
			except Exception as ex:
				messagebox.showerror("Error",f"Dut to:{str(ex)}",parent=self.root)
# ========================== delete function ====================================
	def delete_data(self):
		if self.var_std_id.get()=="":
			messagebox.showerror("Error","Stdent id must be required",parent=self.root)
		else:
			try:
	...
	def generate_dataset(self):
		if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id=="":
			...
			try:
				...
				# ================================ Load predifiened data on face frontal fro open cv=====================
				...
				messagebox.showinfo("Reselt","Generating data sets completes!!!")
			except Exception as ex:
				messagebox.showerror("Error",f"Due to :{str(ex)}",parent=self.root)
